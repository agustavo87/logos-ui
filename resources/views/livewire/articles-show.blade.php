...
<div>
    ...
    {{-- <ul>
        @foreach ($articles as $article)
            <li class=" list-disc ml-2">{{$article->title}} <x-link href="{{ route('articles.show', ['articleID' => $article->id]) }}">Ver</x-link> </li>
        @endforeach
    </ul>
                ...
                <tr x-data="{article: {{ $article->id }}}">
                    ...
                    <td class="text-left py-3 px-4" >
                        <div class="flex flex-row justify-center align-middle">
                            <x-link base="" active=""  class="hover:text-blue-500" href="{{ route('articles.show', ['articleID' => $article->id]) }}">
                            ...
                            <x-link base="" active="" class="hover:text-blue-500 ml-1" href="{{ route('articles.edit', ['articleID' => $article->id]) }}">
                                <svg class="h-5 w-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
