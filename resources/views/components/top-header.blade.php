...
<header
    class="bg-gray-900"
    x-data="{ open: false }">
    <div class="sm:flex sm:justify-between sm:px-4 sm:py-2 sm:items-center max-w-screen-xl mx-auto">
        <div class="flex justify-between items-center px-4 py-3 sm:p-0"> 
            ...
            <div class="sm:hidden" >
                ...
                <svg x-show="!open" class="h-6 w-6 fill-current" x-description="Heroicon name: menu" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
