...
<div {{ $attributes->merge([
    ...
    {{-- Dropdown --}}
    <div @@click.outside="open = false" x-show="open"  x-transition.origin.top x-cloak class="relative mt-2 py-2 bg-gray-800 flex flex-col rounded-lg sm:absolute sm:bg-white sm:shadow-xl">
        {{ $slot }}
    </div>
